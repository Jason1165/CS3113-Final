...
public:
	Entity();
	Entity(GLuint texture_id, std::vector<std::vector<int>> animations, int fps, int animation_frames, int animation_index, int animation_cols, int animation_rows, float width, float height, float speed, int health, int attack);
	~Entity();
	...
	// ----- ANIMATION INDEX ----- //
	void face_left() { m_animation_indices = m_animation[LEFT]; }
	void face_right() { m_animation_indices = m_animation[RIGHT]; }
	void face_idle_left() { m_animation_indices = m_animation[IDLE_LEFT]; }
	void face_idle_right() { m_animation_indices = m_animation[IDLE_RIGHT]; }
